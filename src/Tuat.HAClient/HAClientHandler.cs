...
namespace Tuat.HAClient;

[DisplayName("Home Assistant")]
[Editor("Tuat.HAClient.ClientSettings", typeof(ClientSettings))]
public class HAClientHandler(Client _client, IVariableService _variableService, IMessageBusService _messageBusService) : IClientHandler, IClientConnected
{
    ...
    public Task DeleteVariableInfoAsync(VariableInfo variable, string? entityId)
    {
