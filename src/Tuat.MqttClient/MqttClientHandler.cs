...
namespace Tuat.MqttClient;

[DisplayName("MQTT")]
[Editor("Tuat.MqttClient.ClientSettings", typeof(ClientSettings))]
public class MqttClientHandler(Client _client, IVariableService _variableService, IMessageBusService _messageBusService) : IClientHandler, IClientConnected
{
    ...
    private async Task AddVariableInfoAsync(VariableInfo variable)
    {
    ...
    private async Task UpdateVariableInfoAsync(VariableInfo variable)
    {
    ...
    public async Task DeleteVariableInfoAsync(List<VariableInfo> variables)
    {
        foreach (var variable in variables)
        {
    ...
    private async Task DeleteVariableInfoAsync(VariableInfo variable, string? topic)
    {
